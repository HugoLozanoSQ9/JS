...
/*
    const getObjFormat = (dataArray,rates) =>{
      ...
      let solution ={
        ...
        if(rates[0].includes(item.rate)){
          solution["PG-13"] ++
        }
        else if(rates[1].includes(item.rate)){
          solution.R++
        }else if(rates[2].includes(item.rate)){
          solution.PG++
        }else if(rates[3].includes(item.rate)){
          solution.X++
        }else{
          console.log(`la película ${item} no corresponde a un rating `)
        }
...
console.log( getObjFormat(getRatingsAndMovies(movies)))
//console.log(getRatingsAndMovies(movies))
